...
## NOTE: For the sake of a simple comparison with WT_T338M, the Proteins in the GO-BP term 'Positive Regulation of Mitotic Cell Cycle' in GFP vs WT_T338M are labeled in the volcano plot for GFP vs P8E2_T338I
## However, note that GFP vs WT_T338I did not yield enrichment for the K1 cluster.
...
contrast_name <- "GFP_vs_P8E2_T338M"
...
annotated_plot <- base_plot +
  ggrepel::geom_text_repel(
    data = label_data,
    aes(
      x = GFP_vs_P8E2_T338M_diff,
      y = -log10(GFP_vs_P8E2_T338M_p.adj),
      label = Gene
    ),
    color = "navyblue",
    fontface = "bold",
