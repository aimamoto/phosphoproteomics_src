...
# Set base font size for all plots (change this value to increase/decrease font sizes)
base_font_size <- 16
...
plot_cluster_counts <- function(data, type_label, output_file, base_size = base_font_size) {
