...
overall_peptide_test <- fisher.test(peptide_table, simulate.p.value = TRUE, B = 10000)
...
overall_protein_test <- fisher.test(protein_table, simulate.p.value = TRUE, B = 10000)
